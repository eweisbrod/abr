...
ic_data |> filter(company_fkey=="0000936468") |> select(ic_op_fkey,ic_op_type,form_fkey,file_date,fye_ic_op,fy_ic_op,ic_is_effective) |>
  filter(fy_ic_op>2013) |> arrange(file_date)
